...
export class TrophiesPage {
  public trophies = [
    ...
    { id: 6, name:'Challenger', description: 'Get to top 1 in the ranking' },
    { id: 7, name:'Diamond', description: 'Get to top 100 in the ranking' },
    { id: 8, name:'Gold', description: 'Get to top 1000 in the ranking' },
