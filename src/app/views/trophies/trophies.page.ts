...
export class TrophiesPage {
  ...
  public trophies = [
    ...
    { id: 7, name:'Gold', description: 'Get 3 star in rating' },
    ...
    { id: 16, name:'Other Enthusiastic', description: 'Take care of 5 animal who falls in the Other category' },
    { id: 17, name:'Chimera', description: 'Take care of 10 animal who falls in the Other category' },
